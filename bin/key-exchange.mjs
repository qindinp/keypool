 ...
 * 
 * 用法: node bin/key-exchange.mjs [--port 9201]
 */
...
const KEYPOOL_CONFIG = resolve(PROJECT_ROOT, 'config.json');
const STATE_FILE = resolve(PROJECT_ROOT, '.key-exchange-state.json');
